                ...
                <div class="card border-grey border-lighten-3 m-0">
                    <div class="card-header border-0">
                        <div class="card-title text-center">
                            <div class="p-1">
                                <img src="{{asset('admin/images/logo/logo.gif')}}" width="50%" alt="branding logo">
                            </div>
                        </div>
                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form-horizontal form-simple" action="{{route('user.login')}}" method="post" novalidate>
                                @csrf
                                ...
                                <div class="form-group row">
                                    <div class="col-md-6 col-12 text-center text-md-left">
                                        <fieldset>
                                            <input type="checkbox" id="remember_token" name="remember_token" class="chk-remember">
